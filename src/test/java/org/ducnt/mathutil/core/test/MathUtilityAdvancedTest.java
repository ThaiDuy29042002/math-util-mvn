...
import static org.ducnt.mathutil.core.MathUtility.getFactorial;
...
public class MathUtilityAdvancedTest {
    //tạo mảng 2 chiều sẽ dùng cho việc assertE()
...
//      gắn vs việc các test case để kiểm thử ngay những hàm 
//      dev mình vừa viết
// Viết code chính và viết code test (JUnit, Unit Test) xen kẽ vs nhau
